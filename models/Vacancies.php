...
class Vacancies extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'title' => 'Название',
            'salary' => 'Зарплата',
            'is_for_student' => 'Студентам',
            'description' => 'Описание',
            'is_responseble' => 'Разрешить отклики',
            'is_contactable' => 'Показывать контакты',
            'contact_person' => 'Контактное лицо',
            'views' => 'Просмотры',
            'created_at' => 'Создана',
            'updated_at' => 'Обновлена',
            'expiriencies_id' => 'Требуемый опыт работы',
            'education_id' => 'Требуемое образование',
            'organizations_id' => 'Организация',
            'statuses_id' => 'Статус вакансии',
            'members_id' => 'Сотрудник',
            'cities_id' => 'Город',
        ];
    }
