...
class Summary extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'availability_of_car' => 'Наличие машины',
            ...
            'marital_statuses_id' => 'Семейный статус',
            'business_trips_id' => 'Командировки',
            'relocation_id' => 'Переезд',
            'get_to_work_id' => 'Приступить к работе',
            'expiriencies_id' => 'Опыт работы',
            'education_id' => 'Образование',
            'computer_skills_level_id' => 'Компьютерные навыки',
        ];
    }
